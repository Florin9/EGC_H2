...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0,1), glm::vec3(0, 1, 0.5)),
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 0.1, 1)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 0.2)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 0.6)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0.2, 1, 1)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.7, 1, 1)),
		...
		vector<VertexFormat> vertices1
		{
			...
			VertexFormat(glm::vec3(1, 5,  1), glm::vec3(0, 0.1, 1)),
			// TODO: Complete the information for the cube
		};
		...
		vector<VertexFormat> vertices2
		{
			...
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0.1, 1)),
			// TODO: Complete the information for the cube
		};
		...
		Mesh* tet = CreateMesh("tet", vertices1, indices1);
		Mesh* cube4 = CreateMesh("cube4", vertices2, indices2);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tet"], shaders["VertexColor"], glm::vec3(-6.0f, 0.5f, 0), glm::vec3(0.25f));
	RenderMesh(meshes["cube4"], shaders["VertexColor"], glm::vec3(2.0f, 0.5f, 0), glm::vec3(0.25f));
