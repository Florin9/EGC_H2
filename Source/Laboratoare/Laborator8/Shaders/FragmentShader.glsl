...
void main()
{
	...
	float att = 1/pow(distance(world_position, light_position),2);
    if (diffuse_light > 0)
    {
    ...
    if (type_of_light == 1)
    {
        ...
        {    
            ...
            light = ambient_light + light_att_factor *att* (diffuse_light + specular_light);
        } else
        {
    ...
    {
        light = ambient_light + (diffuse_light + specular_light)*att;
    }
